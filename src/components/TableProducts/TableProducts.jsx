		...
		<div className="tableproducts">
			<div className="tableproducts__table">
				...
				<div className="tableproducts__tbody">
					<ul className="tableproducts__tbody-list">
						...
						<li
							className="tableproducts__tbody-list-item
						tableproducts__tbody-list-item-120"
						>
							Привод
						</li>
						...
						<li
							className="tableproducts__tbody-list-item
						tableproducts__tbody-list-item-140"
						>
							<button className="tableproducts__tbody-list-button">
								<svg
									width="25"
									height="25"
									viewBox="0 0 25 25"
