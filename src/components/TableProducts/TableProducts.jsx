...
import { fetchProducts } from '../../actions/actionGetProducts';
					...
					{products.map((product) => (
						<ul key={product.id} className="tableproducts__tbody-list">
							...
							<li className="tableproducts__tbody-list-item tableproducts__tbody-list-item-140">
								<button className="tableproducts__tbody-list-button tableproducts__tbody-list-button-edit">
									<svg
										width="25"
										height="25"
										viewBox="0 0 25 25"
								...
								<button className="tableproducts__tbody-list-button tableproducts__tbody-list-button-delete">
									<svg
										width="25"
										height="25"
										viewBox="0 0 25 25"
