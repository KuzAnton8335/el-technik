				...
				<div className="cart__wrapper">
					<div className="cart__content">
						<div className="cart__content-body">
							<button className="cart__content-body-btn">
								<svg
									width="25"
									height="25"
									viewBox="0 0 25 25"
							...
							<div className="cart__content-images">
								<img
									src="/src/assets/images/card-img-5.jpg"
									width="225"
									height="243"
									alt="img"
									className="cart__content-image"
								/>
								<p className="cart__content-id">ID товара: 44 </p>
							</div>
							<div className="cart__content-info">
								<h3 className="cart__content-title">
									Электродвигатель 5АИ
								</h3>
								<p className="cart__content-quantity">Количество: 2шт</p>
					...
					<div className="cart__right">
						<div className="cart__total">
							...
							<div className="cart__total-info">
								<span>Итоговая сумма: 20000 руб.</span>
							</div>
